    ...
    <div class="row mt-4">
        <div class="col poppins ps-0 mt-2 pe-0">
            <table class="table layer-bg mb-0">
                ...
                <tr v-for="user of getUsers" :key="user.id">
                    ...
                    <td class="p-3 ps-5 clr-gray">{{user.id}}</td>
                    <td class="p-3 ps-5">
                        <img @click=fetchId(user.id) src="@/assets/icon/edit-pen.svg" type="button" data-bs-toggle="modal" data-bs-target="#setUserModal" alt="pen">
                    </td>
                    <td class="p-3" data-bs-toggle="modal" data-bs-target="#delete">
                        <img @click=fetchId(user.id) src="@/assets/icon/delete.svg" type="button" alt="trash">
                    </td>
                    <!-- Delete modal -->
